 ...
 *
 * Typical usage: a Ktor WebSocket handler subscribes to the campaign-specific channel
 * `kuji:<campaignId>`, and the draw-sync service publishes events there.
 */
public class RedisPubSub(
     ...
     *
     * @param channel The Redis channel name, e.g. `kuji:uuid` or `feed:draws`.
