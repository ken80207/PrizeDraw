...
public class FeedEventRepositoryImpl : IFeedEventRepository {
    ...
    override suspend fun save(event: FeedEvent): Unit = newSuspendedTransaction {
    ...
    override suspend fun findRecent(limit: Int): List<FeedEvent> = newSuspendedTransaction {
        FeedEventsTable
            .selectAll()
