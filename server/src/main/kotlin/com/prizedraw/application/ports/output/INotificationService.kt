 ...
 *
 * Implementations connect to Firebase Cloud Messaging (FCM) or Apple Push Notification
 * service (APNs). Delivery is best-effort; failures should be logged but not surfaced as
