...
/**
 * An immutable ledger entry for a player's revenue-point balance.
 *
 ...
 * @property balanceAfter The player's revenue-point balance after this transaction.
 * @property tradeOrderId FK to the originating [TradeListing] for sale credits.
