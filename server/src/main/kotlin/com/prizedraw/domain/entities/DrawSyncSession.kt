 ...
 * spectators until [DrawSyncService.completeDraw] is called — this is the anti-spoiler guarantee.
 *
 * For kuji draws [ticketId] identifies the specific ticket. For unlimited draws [ticketId] is
 * `null` and the session is correlated by [campaignId] and [playerId].
 *
