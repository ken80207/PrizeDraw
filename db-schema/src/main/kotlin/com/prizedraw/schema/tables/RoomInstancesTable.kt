 ...
 * Upserted by the room scaling service after every join/leave operation so that the
 * global viewer count can be read with a single primary-key lookup instead of a SUM
 * over all shard rows.
 */
