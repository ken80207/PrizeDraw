...
import com.prizedraw.contracts.enums.MessageChannel
import com.prizedraw.contracts.enums.SupportTicketCategory
import com.prizedraw.contracts.enums.SupportTicketPriority
 ...
 *
 * All enum columns map to their respective PG enum types via [pgEnum] using enum types
 * from the api-contracts module.
 */
