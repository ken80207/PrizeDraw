 ...
 * @param appScope A [CoroutineScope] tied to the application lifecycle. The subscription
 *   coroutine is launched as a child of this scope so it is cancelled on shutdown.
 */
