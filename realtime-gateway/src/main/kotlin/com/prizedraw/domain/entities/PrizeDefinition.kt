 ...
 * @property kujiCampaignId FK to a kuji campaign. Non-null only for kuji prize definitions.
 * @property unlimitedCampaignId FK to an unlimited campaign. Non-null only for unlimited definitions.
 * @property grade Prize grade label, e.g. `A賞`, `B賞`, `Last賞`.
 * @property name Product or prize display name.
 * @property photos Ordered list of CDN URLs for prize images.
...
public data class PrizeDefinition(
    ...
    /** Returns true if this definition belongs to a kuji campaign. */
    public fun isKuji(): Boolean = kujiCampaignId != null

    /** Returns true if this definition belongs to an unlimited campaign. */
